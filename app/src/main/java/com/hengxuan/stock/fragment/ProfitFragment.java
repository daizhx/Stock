 ...
 * {@link ProfitFragment.OnFragmentInteractionListener} interface
...
public class ProfitFragment extends Fragment {
    ...
    public static ProfitFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_profit, container, false);
        TextView title = (TextView) root.findViewById(R.id.title_text);
        title.setText(R.string.profit);
        return root;
    }
